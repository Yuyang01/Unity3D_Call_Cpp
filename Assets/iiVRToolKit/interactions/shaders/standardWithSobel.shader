    ...
    SubShader
    {
        ...
        Pass
        {
            CGPROGRAM
				...
				{
					float2 delta = float2(_SobelDeltaX, _SobelDeltaY);
				...
				{
					float s = sobel(_SobelTex, IN.uv);
					return float4(s, s, s, 0.1);
				}
			ENDCG
        }
